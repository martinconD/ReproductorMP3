...
public class Practica1b extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Practica1b.class.getName());
    ...
    private void btnSaludarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaludarActionPerformed
        ...
        String saludo = "Hola, buen día, "+txtNombre.getText()+"!";
        
        JOptionPane.showInternalMessageDialog(null, saludo,
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Practica1b().setVisible(true));
    }
